...
--
-- Host: 127.0.0.1
-- Tempo de geração: 05-Set-2019 às 20:22
...
(18, 'Teste  Front-End', 'Realizar conteúdo proposto anteriormente', 'CRUD com acessos e recuperação de senha', 'https://github.com/vitorserrano', '2019-09-05', 24);
...
(24, 'Teste', 'teste@gmail.com', 'teste@123', '2019-09-05');
...
--
ALTER TABLE `postagem`
  MODIFY `id_postagem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
